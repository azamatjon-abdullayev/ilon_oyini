from tkinter import *                                                                      #by Azamatjon
import random

GAME_WIDTH = 700 #oyin eni
GAME_HEIGHT = 700 #oyin boyi
SPEED = 100  #oyin tezligi
SPACE_SIZE = 50 # oyin katta kichikligi
BODY_PARTS = 3 #ilon uzunligi
SNAKE_COLOR = "#0000FF"
FOOD_COLOR = "#FFFF00"
